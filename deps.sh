...
RUN sudo cp /jansson/jansson.pc /usr/src/mxe/usr/i686-w64-mingw32.shared/lib/pkgconfig/
RUN sudo cp /xerces/xerces-c.pc /usr/src/mxe/usr/i686-w64-mingw32.shared/lib/pkgconfig/
